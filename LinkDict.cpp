...
namespace ROOT {
   static TClass *wuDFMAEVENT_Dictionary();
   static void wuDFMAEVENT_TClassManip(TClass*);
   ...
   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::wuDFMAEVENT*)
   {
      ::wuDFMAEVENT *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::wuDFMAEVENT));
      static ::ROOT::TGenericClassInfo 
         instance("wuDFMAEVENT", "tree.h", 127,
                  typeid(::wuDFMAEVENT), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &wuDFMAEVENT_Dictionary, isa_proxy, 4,
                  sizeof(::wuDFMAEVENT) );
   ...
   TGenericClassInfo *GenerateInitInstance(const ::wuDFMAEVENT*)
   {
      return GenerateInitInstanceLocal((::wuDFMAEVENT*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::wuDFMAEVENT*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *wuDFMAEVENT_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::wuDFMAEVENT*)0x0)->GetClass();
      wuDFMAEVENT_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void *new_wuDFMAEVENT(void *p) {
      return  p ? new(p) ::wuDFMAEVENT : new ::wuDFMAEVENT;
   }
   static void *newArray_wuDFMAEVENT(Long_t nElements, void *p) {
      return p ? new(p) ::wuDFMAEVENT[nElements] : new ::wuDFMAEVENT[nElements];
   }
   // Wrapper around operator delete
   static void delete_wuDFMAEVENT(void *p) {
...
} // end of namespace ROOT for class ::wuDFMAEVENT
...
namespace ROOT {
   static TClass *vectorlEwuDFMAEVENTgR_Dictionary();
   static void vectorlEwuDFMAEVENTgR_TClassManip(TClass*);
   ...
   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<wuDFMAEVENT>*)
   {
      vector<wuDFMAEVENT> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<wuDFMAEVENT>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<wuDFMAEVENT>", -2, "vector", 214,
                  typeid(vector<wuDFMAEVENT>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEwuDFMAEVENTgR_Dictionary, isa_proxy, 4,
      ...
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<wuDFMAEVENT> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<wuDFMAEVENT>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEwuDFMAEVENTgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<wuDFMAEVENT>*)0x0)->GetClass();
      vectorlEwuDFMAEVENTgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void *new_vectorlEwuDFMAEVENTgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<wuDFMAEVENT> : new vector<wuDFMAEVENT>;
   }
   static void *newArray_vectorlEwuDFMAEVENTgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<wuDFMAEVENT>[nElements] : new vector<wuDFMAEVENT>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEwuDFMAEVENTgR(void *p) {
...
} // end of namespace ROOT for class vector<wuDFMAEVENT>
...
struct __attribute__((annotate("$clingAutoload$tree.h")))  wuDFMAEVENT;
...
typedef struct wuDFMAEVENT wuDFMAEVENT __attribute__((annotate("$clingAutoload$tree.h"))) ;
)DICTFWDDCLS";
